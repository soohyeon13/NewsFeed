...
import kr.ac.jejunu.myrealtrip.databinding.TabFragmentEntertainBinding
...
class EntertainFragment : BaseFragment<TabFragmentEntertainBinding>(R.layout.tab_fragment_entertain) {
    companion object{
        fun newInstance(cate: String): Fragment {
            val fragment = EntertainFragment()
            val args = Bundle()
    ...
    private val viewModel : EntertainViewModel by inject()
...
//            })
    ...
    private fun observe() {
        viewModel.entertainNewsItemsLiveData.observe(viewLifecycleOwner, Observer {
