...
import kr.ac.jejunu.myrealtrip.databinding.TabFragmentSportsBinding
...
class SportsFragment : BaseFragment<TabFragmentSportsBinding>(R.layout.tab_fragment_sports) {
    companion object{
    ...
    private val viewModel : SportsViewModel by inject()
...
//            })
    ...
    private fun observe() {
        viewModel.sportsNewsItemsLiveData.observe(viewLifecycleOwner, Observer {
