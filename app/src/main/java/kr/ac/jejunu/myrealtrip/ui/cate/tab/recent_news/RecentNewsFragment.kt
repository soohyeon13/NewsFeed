...
import kr.ac.jejunu.myrealtrip.databinding.TabFragmentRecentNewsBinding
...
class RecentNewsFragment :BaseFragment<TabFragmentRecentNewsBinding>(R.layout.tab_fragment_recent_news){
    companion object{
        fun newInstance(cate: String): Fragment {
            val fragment = RecentNewsFragment()
            val args = Bundle()
    ...
    private val viewModel : RecentNewsViewModel by inject()
