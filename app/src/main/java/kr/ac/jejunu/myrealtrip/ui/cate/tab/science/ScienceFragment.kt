...
import kr.ac.jejunu.myrealtrip.databinding.TabFragmentScienceBinding
...
class ScienceFragment : BaseFragment<TabFragmentScienceBinding>(R.layout.tab_fragment_science) {
    companion object {
    ...
    private val viewModel : ScienceViewModel by inject()
...
//            })
    ...
    private fun initView() {
        viewModel.scienceNewsItemsLiveData.observe(viewLifecycleOwner, Observer {
